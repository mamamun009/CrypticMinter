...
const SelectField = ({
  ...
  return (
    <div className="relative flex flex-col flex-1 ">
      <label htmlFor="range" className="text-lg font-bold ">
        {label}
      </label>

      <div
        className=" flex items-center relative mt-1 py-4 px-3 min-h-[60px]  text-xl w-full bg-white border-2 border-gray-200 rounded-lg  text-gray-500"
      ...
      >
        ...
        <span className="absolute -translate-y-1/2 top-1/2 right-3">
          <Icon icon={chevronDownIcon} className="w-6 h-6 fill-gray-500" />
        </span>
      </div>
