  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-2 mt-8 border">
      ...
      <div className="flex w-full px-10 mt-6">
        <div className="flex flex-col flex-1 text-sm leading-[18.85px] font-light font-madeOuterSans border-b border-black">
          <h5>Created by</h5>
      ...
      <h3 className="mt-1 text-2xl font-medium text-center font-madeOuterSans text-black/30">
        1 of 1 Edition
      </h3>
